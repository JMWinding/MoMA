...
void setup () 
{
  ...
  assert (sizeof (cdmacode) == sizeof (cdmacode[0])*cdmanum);
  goldlen = settingFile.parseInt ();
  cdmalen = goldlen * 2;
  assert (sizeof (cdmacode[0]) == sizeof (cdmacode[0][0])*goldlen);
