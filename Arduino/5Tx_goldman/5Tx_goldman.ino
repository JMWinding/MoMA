...
// **** Pump Parameters ****
const int nTx = 5;
const int motors[nTx] = {2, 3, 4, 5, 6};
const int motorOffsets[nTx] = {20, 20+14*(1+prelen)*1, 20+14*(1+prelen)*2, 20+14*(1+prelen)*3, 20+14*(1+prelen)*4};
const float motorCon[nTx] = {10, 10, 10, 10, 10};
